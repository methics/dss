...
class MRAWithCustomCertificateContentDeclarationPointedPartyQcComplianceWrongKeyUsageTest extends AbstractMRALOTLTest {
    ...
    protected Condition getCertificateContentDeclarationPointedPartyQcCompliance() {
        return new KeyUsageCondition(KeyUsageBit.DIGITAL_SIGNATURE, true);
    }
