...
class MRAWithCustomCertificateContentDeclarationPointedPartyQcComplianceKeyUsageSetTest extends AbstractMRALOTLTest {
    ...
    protected Condition getCertificateContentDeclarationPointedPartyQcCompliance() {
        ...
        keyUsageConditions.add(new KeyUsageCondition(KeyUsageBit.DIGITAL_SIGNATURE, false));
