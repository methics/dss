...
class MRAWithCustomCertificateContentDeclarationPointedPartyQcComplianceWrongExtendedKeyUsageTest extends AbstractMRALOTLTest {
    ...
    protected Condition getCertificateContentDeclarationPointedPartyQcCompliance() {
        return new ExtendedKeyUsageCondition(Collections.singletonList(ExtendedKeyUsage.TIMESTAMPING.getOid()));
    }
