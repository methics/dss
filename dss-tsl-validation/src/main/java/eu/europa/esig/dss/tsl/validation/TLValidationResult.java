 ...
 */
public class TLValidationResult implements ValidationResult {
	 ...
	 */
	public TLValidationResult(Indication indication, SubIndication subIndication, Date signingTime,
