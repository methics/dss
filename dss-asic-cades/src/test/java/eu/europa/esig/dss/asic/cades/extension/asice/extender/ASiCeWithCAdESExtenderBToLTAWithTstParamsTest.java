...
class ASiCeWithCAdESExtenderBToLTAWithTstParamsTest extends ASiCeWithCAdESExtenderBToLTATest {
        ...
        if (extended) {
            ...
            for (TimestampWrapper timestampWrapper : timestampList) {
                if (TimestampType.SIGNATURE_TIMESTAMP == timestampWrapper.getType()) {
                    ...
                    sigTstFound = true;
                } else if (TimestampType.CONTAINER_TIMESTAMP == timestampWrapper.getType()) {
