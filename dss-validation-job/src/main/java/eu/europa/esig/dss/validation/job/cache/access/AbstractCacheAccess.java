...
public abstract class AbstractCacheAccess {
	...
	private static final Logger LOG = LoggerFactory.getLogger(AbstractCacheAccess.class);
	 ...
	 */
	protected AbstractCacheAccess(final DownloadCache fileCache, final ParsingCache parsingCache,
