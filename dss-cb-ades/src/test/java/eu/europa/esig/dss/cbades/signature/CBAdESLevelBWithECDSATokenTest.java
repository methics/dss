...
@Tag("slow")
class CBAdESLevelBWithECDSATokenTest extends AbstractCBAdESTestSignature {
    ...
    private static Stream<Arguments> data() {
        ...
        for (DigestAlgorithm digestAlgo : DigestAlgorithm.values()) {
            ...
            if (ecCa != null && ecCa.getCOSEId() != null && plainEcCa != null && plainEcCa.getCOSEId() != null) {
    ...
    @ParameterizedTest(name = "Combination {index} of PLAIN_ECDSA with {0} and signer {1}")
    @MethodSource("data")
