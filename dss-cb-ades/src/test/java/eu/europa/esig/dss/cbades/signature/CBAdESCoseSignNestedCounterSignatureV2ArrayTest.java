...
class CBAdESCoseSignNestedCounterSignatureV2ArrayTest extends AbstractCBAdESTestValidation {
    ...
    @BeforeEach
    void init() {
        signedDocument = new FileDocument("src/test/resources/validation/cb-ades-cosesign-countersignatureV2-rfc9338-array.cose");
