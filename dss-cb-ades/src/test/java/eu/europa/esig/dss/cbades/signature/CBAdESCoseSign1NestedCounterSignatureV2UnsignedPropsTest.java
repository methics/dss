...
class CBAdESCoseSign1NestedCounterSignatureV2UnsignedPropsTest extends AbstractCBAdESTestValidation {
    ...
    @BeforeEach
    void init() {
        signedDocument = new FileDocument("src/test/resources/validation/cb-ades-cosesign1-countersignatureV2-rfc9338-unsigned-prop.cose");
