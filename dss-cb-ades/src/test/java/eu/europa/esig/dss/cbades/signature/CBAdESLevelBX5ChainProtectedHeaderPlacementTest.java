...
class CBAdESLevelBX5ChainProtectedHeaderPlacementTest extends AbstractCBAdESTestSignature {
    ...
    void init() {
        ...
        signatureParameters.setX5ChainHeaderPlacement(CBAdESSignatureParameters.X5ChainHeaderPlacement.protectedHeader);
    }
