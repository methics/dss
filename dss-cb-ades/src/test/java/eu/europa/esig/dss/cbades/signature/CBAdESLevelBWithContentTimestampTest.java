...
class CBAdESLevelBWithContentTimestampTest extends AbstractCBAdESTestSignature {
    ...
    protected void checkTimestamps(DiagnosticData diagnosticData) {
        ...
        assertTrue(cntTst.isMessageImprintDataIntact());
        assertTrue(cntTst.isSignatureIntact());
        assertTrue(cntTst.isSignatureValid());
    }
