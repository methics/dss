...
class JAdESLevelBEnvelopedDuplicateSignatureTest extends PKIFactoryAccess {

    private static final I18nProvider i18nProvider = new I18nProvider();

    @Test
    void test() throws Exception {
        DSSDocument document = new FileDocument(new File("src/test/resources/sample.json"));
