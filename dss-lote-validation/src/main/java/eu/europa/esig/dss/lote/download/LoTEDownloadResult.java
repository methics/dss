 ...
 */
package eu.europa.esig.dss.lote.download;
 ...
 */
public class LoTEDownloadResult implements DownloadResult {
	 ...
	 */
	public LoTEDownloadResult(DSSDocument dssDocument, Digest digest) {
	...
	public List<String> getSha2ErrorMessages() {
		// TODO : not supported, to be removed
