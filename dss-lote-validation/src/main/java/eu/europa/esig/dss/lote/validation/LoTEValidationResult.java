 ...
 */
package eu.europa.esig.dss.lote.validation;
 ...
 */
public class LoTEValidationResult implements ValidationResult {
	 ...
	 */
	public LoTEValidationResult(Indication indication, SubIndication subIndication, Date signingTime,
