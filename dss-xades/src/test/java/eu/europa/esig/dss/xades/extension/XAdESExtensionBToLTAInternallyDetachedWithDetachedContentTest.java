...
class XAdESExtensionBToLTAInternallyDetachedWithDetachedContentTest extends AbstractXAdESTestExtension {

    private final DSSDocument WRONG_DOCUMENT = new InMemoryDocument("Bye world".getBytes(), "evil.txt");

    private final FileDocument ORIGINAL_DOCUMENT = toFileDocument(new FileDocument("src/test/resources/sample-with-id.xml"));
