...
class XAdESWithASN1SignaturePolicyWithPolicyDependentValidatorTest extends AbstractXAdESTestSignature {
    ...
    void init() throws Exception {
        ...
        byte[] digest = new BasicASN1SignaturePolicyValidator().getComputedDigest(POLICY_CONTENT, DigestAlgorithm.SHA256).getValue();
    ...
    protected SignedDocumentValidator getValidator(DSSDocument signedDocument) {
        ...
        validator.setSignaturePolicyValidatorLoader(DefaultSignaturePolicyValidatorLoader.policyBasedSignaturePolicyValidatorLoader());
        return validator;
    }
    ...
    protected void checkSignaturePolicyIdentifier(DiagnosticData diagnosticData) {
        ...
        assertEquals("UB1ptLcfxuVzI8LHQTGpyMYkCb43i6eI3CiFVWEbnlg=", Utils.toBase64(signature.getPolicyDigestAlgoAndValue().getDigestValue()));
