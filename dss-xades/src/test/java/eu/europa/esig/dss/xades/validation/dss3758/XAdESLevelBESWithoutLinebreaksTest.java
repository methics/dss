...
class XAdESLevelBESWithoutLinebreaksTest extends AbstractXAdESTestValidation {

    @Override
    protected DSSDocument getSignedDocument() {
        return new FileDocument(new File("src/test/resources/validation/dss3758/xades-bes-issuer-no-linebreaks.xml"));
    }
