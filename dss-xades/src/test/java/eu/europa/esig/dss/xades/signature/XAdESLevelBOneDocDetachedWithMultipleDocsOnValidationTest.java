...
class XAdESLevelBOneDocDetachedWithMultipleDocsOnValidationTest extends AbstractXAdESTestSignature {
    ...
    protected List<DSSDocument> getDetachedContents() {
        DSSDocument otherDocument = new InMemoryDocument("Hello World!".getBytes(), "helloWorld");
