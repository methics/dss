...
This chapter covers the most significant changes in DSS code occurred between different versions, requiring review and possible changes from code implementers.
...
[cols="2,5,5"]
.Code changes from version 6.5.RC1 to 6.5
|===
|Title                               |v6.5.RC1                            |v6.5
a|SD-JWT and Mdoc modules          a|
[source,xml]
----
<dependency>
	<groupId>eu.europa.ec.joinup.sd-dss</groupId>
	<artifactId>dss-eaa-jwt</artifactId>
</dependency>
<dependency>
	<groupId>eu.europa.ec.joinup.sd-dss</groupId>
	<artifactId>dss-eaa-mdoc</artifactId>
</dependency>
----
a|
[source,xml]
...
<dependency>
	<groupId>eu.europa.ec.joinup.sd-dss</groupId>
	<artifactId>dss-sd-jwt</artifactId>
</dependency>
<dependency>
	<groupId>eu.europa.ec.joinup.sd-dss</groupId>
	<artifactId>dss-mdoc</artifactId>
</dependency>
----

a|Attestation creation          a|
[source,java]
----
...
DefaultEAAPresentationValidator validator = DefaultEAAPresentationValidator.fromDocument(presentationDocument);
...
DefaultAttestationDocumentValidator validator = DefaultAttestationDocumentValidator.fromDocument(presentationDocument);
validator.setCertificateVerifier(commonCertificateVerifier);
Reports reports = validator.validateDocument();
...
AttestationDocument attestationDocument = service.parseAttestation(attestation);
DSSDocument signedAttestation = attestationDocument.getSignedAttestation();
List<SDJWTSelectiveDisclosure> disclosures = attestationDocument.getSelectiveDisclosures();
...
|===
|Title                               |v6.4                            |v6.5
a|DPI handling on PDF visual signature creation          a|
Image is zoomed inversely to the PDF DPI, when no field dimensions defined.
                                                                     a|
Image is created keeping the original dimensions, when new DPI behavior is enabled.

Please see the section <<PdfDPI>> for more information.

a|XML Namespace registration          a|
[source,java]
----
import eu.europa.esig.dss.xml.common.definition.DSSNamespace;
import eu.europa.esig.dss.xml.utils.DomUtils;

DSSNamespace namespace = new DSSNamespace("http://uri.etsi.org/01903/v1.3.2#", "xades");
Element element = DomUtils.registerNamespace(namespace);
----
a|
[source,java]
----
...
DSSNamespace namespace = new DSSNamespace("http://uri.etsi.org/01903/v1.3.2#", "xades");
Element element = XPathUtils.registerNamespace(namespace);
----

a|Selected Namespace validation           a|
[source,java]
----
...
XMLDocumentValidator xmlDocumentValidator = new XMLDocumentValidator(
        xmlDocument, Collections.singletonList(new XAdES132Path()));
----

a|XPath DOM lookup          a|
[source,java]
----
import eu.europa.esig.dss.xml.utils.DomUtils;
import org.w3c.dom.Element;

Element element = DomUtils.getElement(document, "./ds:Signature");
----
a|
[source,java]
----
...
XPathQuery query = XPathQueryBuilder.fromCurrentPosition().element(XMLDSigElement.SIGNATURE).build();
Element element = XPathUtils.getElement(document, query);
----

a|PAdES SecureRandom          a|
[source,java]
----
...
PdfBoxSignatureService padesSignatureService = ...
SecureRandomProvider secureRandomProvider = new DSSSecureRandomProvider(parameters);
padesSignatureService.setSecureRandomProvider(secureRandomProvider);
----
a|
[source,java]
----
...
PdfBoxSignatureService padesSignatureService = ...
SecureRandomProvider secureRandomProvider = new DSSSecureRandomProvider();
padesSignatureService.setSecureRandomProvider(secureRandomProvider);
----

a|TLValidationJob management classes          a|
[source,java]
----
...
|===
|Title                               |v6.3                            |v6.4
a|Cryptographic suite's validation level definition          a|
[source,java]
----
...
a|CMS classes moved from `dss-cades` to `dss-cms`          a|
[source,java]
----
...
[source,java]
----
import eu.europa.esig.dss.cms.asn1.CertifiedAttributesV2;
...
a|`CAdESUtils` methods deprecation          a|
[source,java]
----
...
boolean isEmpty = CAdESUtils.isEmpty(attributeTable);
AttributeTable notNullAttributeTable = CAdESUtils.emptyIfNull(attributeTable);
boolean isAttributeOfType = CAdESUtils.isAttributeOfType(attributeTable, asn1ObjectIdentifier);
----
                                                                     a|
...
boolean isEmpty = DSSASN1Utils.isEmpty(attributeTable);
AttributeTable notNullAttributeTable = DSSASN1Utils.emptyIfNull(attributeTable);
boolean isAttributeOfType = DSSASN1Utils.isAttributeOfType(attributeTable, asn1ObjectIdentifier);
----

a|Simplified CMS generation          a|
[source,java]
----
...
// configure CMSBuilder
cmsBuilder.setOriginalCMS(originalCms);
...
CMSForCAdESBuilderHelper cmsBuilderHelper = new CMSForCAdESBuilderHelper(contentToSign, signatureParameters, contentSigner);
// configure CMSForCAdESBuilderHelper
cmsBuilderHelper.setOriginalCMS(originalCms);
CMS cms = cmsBuilderHelper.createCMS();
----

a|`AIACertificateSource` instantiation          a|
[source,java]
----
import eu.europa.esig.dss.spi.x509.aia.AIACertificateSource;

AIACertificateSource aiaCertificateSource = new AIACertificateSource(certificateToken, aiaSource);
----
                                                                     a|
...
AIACertificateSource aiaCertificateSource = AIACertificateSource.forCertificateToken(certificateToken, aiaSource);
----

a|TLS/SSL certificates downloading          a|
[source,java]
----
...
sslCertificateLoader.setCommonsDataLoader(new CommonsDataLoader());
List<CertificateToken> certificates = sslCertificateLoader.getCertificates("https://website.com");
----
                                                                     a|
...
ResponseEnvelope response = dataLoader.requestGet("https://website.com");
Certificate[] certificates = response.getTLSCertificates();
----
Hint: for validation of TLS/SSL certificates please see <<QWACValidation>>.

a|`NativeDataLoaderCall` deprecated          a|
[source,java]
----
import eu.europa.esig.dss.spi.client.http.NativeDataLoaderCall;

NativeDataLoaderCall nativeDataLoaderCall = new NativeDataLoaderCall(
        url, content, refresh, maxInputSize, connectTimeout, readTimeout);
byte[] responseBytes = nativeDataLoaderCall.call();
----
                                                                     a|
...
----
import eu.europa.esig.dss.model.http.ResponseEnvelope;
import eu.europa.esig.dss.spi.client.http.NativeHTTPDataLoaderCall;
...
ResponseEnvelope response = httpDataLoaderCall.call();
byte[] responseBytes = responsegetResponseBody();
----

a|`DSSUtils#getX500PrincipalOrNull` moved to `DSSASN1Utils`          a|
[source,java]
----
import eu.europa.esig.dss.spi.DSSUtils;
import javax.security.auth.x500.X500Principal;

X500Principal x500Principal = DSSUtils.getX500PrincipalOrNull(x500NameString);
----
                                                                     a|
...
X500Principal x500Principal = DSSASN1Utils.getX500PrincipalOrNull(x500NameString);
----

a|`CRLRef` instantiation          a|
[source,java]
----
...
CRLRef crlRef = new CRLRef(digest, crlIssuer, crlIssuedTime, crlNumber);
----

a|Trusted List criteria extensions           a|
[source,java]
----
...
import eu.europa.esig.dss.jaxb.parsers.AssertParser;
----

a|Trusted List v2.1.1 utils           a|
[source,java]
----
import eu.europa.esig.trustedlist.TrustedList211Utils;
import eu.europa.esig.trustedlist.TrustedList211Facade;
----
                                                                     a|
...
import eu.europa.esig.trustedlist211.TrustedList211Facade;
----

a|JAXB PKI Factory `X509CertificateBuilder`                          a|
[source,java]
----
...
certBuilder.issuer(issuerX500Name, issuerPrivateKey, signatureAlgo);
...
----
                                                                     a|
...
|===
|Title                               |v6.2                            |v6.3
a|Default validation process requires the `dss-policy-jaxb` module           a|
[source,xml]
.pom.xml
----
<dependencies>
...
----
                                                                     a|
In order to benefit from default XML Validation Policy, please add the `dss-policy-jaxb` module:
...
a|CAdES/PAdES signature and validation (see <<dssCms>>)             a|
[source,xml]
.pom.xml
----
<dependencies>
...
<dependencies>
    ...
    <!-- dss-cms implementation shall be added -->
    <dependency>
        <groupId>eu.europa.ec.joinup.sd-dss</groupId>
...
a|Old `CMSUtils` moved to `CAdESUtils`             a|
[source,java]
----
...
a|`CAdESSignatureExtension` and related classes             a|
[source,java]
----
import eu.europa.esig.dss.cades.signature.CAdESSignatureExtension;
import org.bouncycastle.cms.CMSSignedData;

CAdESSignatureExtension cadesExtension = ...
CMSSignedData cmsSignedData = ...
cmsSignedData = cadesExtension.extendCMSSignatures(cmsSignedData, signatureParameters);
----
                                                                     a|
Replaced by a new `CMS` object
[source,java]
----
...
CAdESSignatureExtension cadesExtension = ...
CMS cms = ...
cms = cadesExtension.extendCMSSignatures(cms, signatureParameters);
----

a|Min and Max signature extension times             a|
[source,java]
----
import eu.europa.esig.dss.simplereport.SimpleReport;
...
Date extensionPeriodMin = simpleReport.getSignatureExtensionPeriodMin(signatureId);
Date extensionPeriodMax = simpleReport.getSignatureExtensionPeriodMax(signatureId);
----
                                                                     a|[source,java]
----
import eu.europa.esig.dss.simplereport.SimpleReport;
