...
class TLSCertificateBindingSignatureFoundCheckTest extends AbstractTestCheck {
    ...
    void validTest() {
        ...
        TLSCertificateBindingSignatureFoundCheck tlscbsfc = new TLSCertificateBindingSignatureFoundCheck(
