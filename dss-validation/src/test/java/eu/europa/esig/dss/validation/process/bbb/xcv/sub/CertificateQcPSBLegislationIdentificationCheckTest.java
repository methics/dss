...
class CertificateQcPSBLegislationIdentificationCheckTest extends AbstractTestCheck {
    ...
    void validTest() {
        ...
        CertificateQcPSBLegislationIdentificationCheck cqcpsblic = new CertificateQcPSBLegislationIdentificationCheck(
    ...
    void notDefinedTest() {
        ...
        XmlQcPSB xmlQcPSB = new XmlQcPSB();
        xmlQcPSB.setCountryOfLegislation("ID-12345");
        xmlQcStatements.setQcPSB(xmlQcPSB);
