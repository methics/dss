...
class CertificateQcPSBAuthSourceIdentificationCheckTest extends AbstractTestCheck {
    ...
    void validTest() {
        ...
        CertificateQcPSBAuthSourceIdentificationCheck cqcpsbasic = new CertificateQcPSBAuthSourceIdentificationCheck(
