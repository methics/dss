...
/**
 * Validates the result of a Signature Algorithm cryptographic checker
 *
 * @param <T> {@code XmlConstraintsConclusion}
 */
public class SignatureAlgorithmCryptographicCheckerResultCheck<T extends XmlConstraintsConclusion> extends AbstractCryptographicCheckerResultCheck<T> {
	 ...
	 */
	public SignatureAlgorithmCryptographicCheckerResultCheck(I18nProvider i18nProvider, T result, Date validationDate,
	 ...
	 */
	public SignatureAlgorithmCryptographicCheckerResultCheck(I18nProvider i18nProvider, T result, Date validationDate, Context context,
	...
	protected XmlBlockType getBlockType() {
		if (Context.CERTIFICATE == context) {
	...
	protected String buildAdditionalInfo() {
		...
		if (isValid(ccResult)) {
			XmlCryptographicValidation cryptographicValidation = ccResult.getCryptographicValidation();
