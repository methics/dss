...
/**
 * Performs validation for signature based tokens
 *
 * @param <S> {@link AbstractSignatureWrapper}
 */
public abstract class AbstractSignatureFormatChecking<S extends AbstractSignatureWrapper> extends AbstractFormatChecking<S> {
     ...
     */
    protected AbstractSignatureFormatChecking(I18nProvider i18nProvider, DiagnosticData diagnosticData, S token,
                                              Context context, ValidationPolicy policy) {
        super(i18nProvider, diagnosticData, token, context, policy);
    }
