 ...
 */
public class TimestampDigestAlgorithmValidationCheck<T extends XmlConstraintsConclusion> extends ChainItem<T> {
     ...
     * @param cvResult {@link XmlCryptographicValidation}
     * @param currentTime {@link Date}
     * @param constraint {@link LevelRule}
     */
    public TimestampDigestAlgorithmValidationCheck(I18nProvider i18nProvider, T result,
                                                   TimestampWrapper timestamp,
                                                   XmlCryptographicValidation cvResult, Date currentTime,
    ...
    protected boolean process() {
        return cvResult != null && isValidConclusion(cvResult.getConclusion());
    }
    ...
    protected Indication getFailedIndicationForConclusion() {
        return cvResult.getConclusion().getIndication();
    }

    @Override
    protected SubIndication getFailedSubIndicationForConclusion() {
        return cvResult.getConclusion().getSubIndication();
    }
