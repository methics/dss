...
public abstract class AbstractCertificateValidator<R extends AbstractReports, PE extends ProcessExecutor<R>> implements ProcessExecutorProvider<PE> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(AbstractCertificateValidator.class);
     ...
     */
    protected ValidationContextExecutor validationContextExecutor = DefaultValidationContextExecutor.INSTANCE;
     ...
     * Default constructor
     */
    protected AbstractCertificateValidator() {
        // empty
    }
     ...
     * @return {@link CertificateReports}
     */
    public R validate(final URL validationPolicyURL) {
     ...
     * @return {@link CertificateReports}
     */
    public R validate(final String policyResourcePath) {
     ...
     * @return {@link CertificateReports}
     */
    public R validate(final File policyFile) {
     ...
     * @return {@link CertificateReports}
     */
    public R validate(DSSDocument policyDocument) {
     ...
     * @return {@link CertificateReports}
     */
    public R validate(final InputStream policyDataStream) {
     ...
     * @return {@link CertificateReports}
     */
    public R validate(URL validationPolicyURL, URL cryptographicSuiteURL) {
     ...
     * @return {@link CertificateReports}
     */
    public R validate(String policyResourcePath, String cryptographicSuitePath) {
     ...
     * @return {@link CertificateReports}
     */
    public R validate(File policyFile, File cryptographicSuiteFile) {
     ...
     * @return {@link CertificateReports}
     */
    public R validate(DSSDocument policyDocument, DSSDocument cryptographicSuiteDocument) {
    ...
    /**
     * Returns the default validation policy path
     *
     * @return {@link String}
     */
    protected abstract String getDefaultValidationPolicyPath();
     ...
     * @return {@link CertificateReports}
     */
    public R validate(InputStream policyDataStream, InputStream cryptographicSuiteStream) {
     ...
     * @return {@link CertificateReports}
     */
    public R validate(ValidationPolicy validationPolicy) {
        assertConfigurationValid();

        final XmlDiagnosticData diagnosticData = getDiagnosticData();

        PE executor = provideProcessExecutorInstance();
    ...
    protected DiagnosticDataBuilder createDiagnosticDataBuilder(final ValidationContext validationContext) {
        return initDiagnosticDataBuilder()
    ...
    /**
     * Instantiates a new DiagnosticDataBuilder
     *
     * @return {@link DiagnosticDataBuilder}
     */
    ...
    /**
     * Gets the {@link ProcessExecutor}
     *
     * @return {@link ProcessExecutor}
     */
    protected abstract PE provideProcessExecutorInstance();

    @Override
    public void setProcessExecutor(PE processExecutor) {
